package com.citizenService.CitizenService.config;
...
@Configuration
public class SpringSecConfigCitizen extends WebSecurityConfigurerAdapter {
    @Override
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable();
        http.authorizeRequests().antMatchers("/citizen/id/**").hasAnyRole("ADMIN")
